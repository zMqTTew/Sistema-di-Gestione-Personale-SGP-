...
TIPI_FILE = {
    ...
    "Video": [".mp4", ".mkv"],
    "Audio": [".mp3"],
    "Programmazione": [".py", ".js", ".java", ".c", ".cpp", ".php", ".html", ".css", ".php", ".sql"]
}
    ...
    for file in os.listdir(cartella):
        ...
        if os.path.isdir(percorso):
            ...
            if estensione in [".jpg", ".png", ".jpeg"]:
                ...
                icona = "🎵"
            elif estensione == [".py", ".js", ".java", ".c", ".cpp", ".php", ".html", ".css", ".php", ".sql"]:
                icona= "🖥️"

            elementi.append(f"{icona} {file}")

    return elementi[:30] # PER EVITARE CRASH O LISTE TROPPO LUNGHE
